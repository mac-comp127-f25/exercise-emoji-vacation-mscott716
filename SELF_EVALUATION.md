...
I was challenged by the positionFamily method. To overcome this I drew out the positions of the emojis and how the variables being passed into positinFamily are being used. I eventually realized that I was not adding the total amount of x distance covered to each emoji and without a cummulation variable, the positions would not be accurate.
...
I thought it was interesting to interact with the random class. Coding random variables is somewhat similar to Python, but after learning how classes and class methods work, I understand the syntax of using the random class better.
